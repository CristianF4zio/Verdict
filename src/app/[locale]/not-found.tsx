...
export default async function NotFound() {
  ...
  return (
    <div className="mx-auto max-w-[1280px] px-7 py-24">
      ...
      <Link
        href="/"
        className="inline-block rounded-md border border-panel-line bg-panel px-5 py-3.5 text-sm font-medium text-panel-ink transition-all duration-150 hover:-translate-y-0.5 hover:border-signal hover:bg-signal hover:text-on-signal"
      >
        {t("cta")}
      </Link>
    </div>
