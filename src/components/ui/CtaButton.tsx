  ...
  return (
    <div className={fullWidth ? "" : "inline-block"}>
      <a
        ...
        target="_blank"
        className={`block rounded-full px-5 py-3.5 text-center text-sm font-medium transition-all duration-200 hover:-translate-y-1 ${styles[variant]} ${fullWidth ? "w-full" : ""}`}
      >
        {label}
      </a>
      {disclosure && (
